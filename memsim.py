...
def main():
    ...
    print(f"page fault rate: {format((mmu.get_total_page_faults() / no_events), '.4f')}")

if __name__ == "__main__":
    # command format: python memsim.py memory_trace_file number_of_page_frames algorithm mode
    # command format: python memsim.py sample.trace 1 1 1
    main()
